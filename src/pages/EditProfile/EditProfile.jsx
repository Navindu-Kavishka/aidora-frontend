...
<ul className="navbar-nav ms-auto d-flex flex-row" style={{ marginBottom: '0' }}>
                        ...
                        <div className="p-3 py-5">
                            ...
                            <div className="row mt-3">
                                <div className="col-md-12" >
                                    ...
                                    <input type="text" className="form-control" placeholder="Company Name" style={{ boxShadow: 'none', borderColor: '#BA68C8' }} />
                                </div>
    ...
    <button className="btn btn-primary profile-button" type="button" style={{backgroundColor:'#037149'}}>Save</button>
</div>
